...
export const createPaymentSchema = z.object({
  ...
  principalAmount: z.coerce.number().min(0, "Principal amount cannot be negative"),
  interestAmount: z.coerce.number().min(0, "Interest amount cannot be negative"),
  feesAmount: z.coerce.number().min(0, "Fees amount cannot be negative").optional(),
